...
\end{center}
 \caption{See page for author CC BY 4.0  (https://creativecommons.org/licenses/by/4.0 ), via Wikimedia Commons https://commons.wikimedia.org/wiki/File:Advert_for_Tofranil_Geigy_Wellcome_L0043517.jpg }
\label{fig: MattachinePamphlet}
\end{marginfigure}
