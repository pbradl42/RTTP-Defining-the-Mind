...
\textbackslash{}end\{center\}
 \textbackslash{}caption\{Notice of Ebbinghaus' book ``Psychology'', from the Brooklyn Daily Eagle, Dec 19, 1908\}
\textbackslash{}label\{fig: ebbinghaus-clip\}
...
\newthought{This study lacks internal validity}.. Internal validity looks inside the experiment to the design of the experiment. The central question of internal validity is this: Was the experiment designed so as to determine what was really happening?
...
\newthought{This lack of generalizability is called 'external validity'.} External validity, looks outside the experiment itself to what conclusions can be drawn from the resulting data.
...
\newthought{stimulating}

\newthought{inhibiting}
