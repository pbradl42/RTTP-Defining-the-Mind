...
``The increasing dominance of language habits in the behavior of the developing child leads naturally over into the behaviorist's conception of thinking. The behaviorist makes no mystery of thinking. He holds that thinking is behavior, is motor organization, just like tennis playing or golf or any other form of muscular activity. But what kind of muscular activity? The muscular activity that he uses in talking. Thinking is merely talking, but talking with concealed musculature.'' ~\citep[p. 464]{Watson:1926wd}
\end{quote}
...
\begin{thesis}[Auxiliary Hypothesis]\label{thesis:auxiliaryhypothesis}
...
\newthought{Two of the major risks} of observational research are observer bias and reactivity.
...
Dependent variable
\begin{thesis}[Dependent variable]
...
\newthought{The first form of validity} looks inside the experiment to the design of the experiment. The central question of internal validity is this: Was the experiment designed so as to determine what was really happening?
...
\end{thesis}
\newthought{The second form}, external validity, looks outside the experiment itself to what conclusions can be drawn from the resulting data.
