...
When one reviews these offerings, one is struct by the lack of variation. All cite the same historical movements---including, somewhat surprisingly, humanistic psychology. They \emph{all} define science as a method or procedure, and all reject the notion that science is a body of knowledge to be memorized. This cannot be random. No equivalent set of texts in Philosophy would be as uniform.
