...
These guidelines were superseded by ‘Version 2.0’ in 2013. The same themes reappear:
...
1.1 Describe key concepts, principles, and overarching themes in psychology.
    ...
    1.1d Recognize the power of the context in shaping conclusions about individudal behavior.

    1.1e Identify fields other than psychology that address behavioral concerns.
\end{verbatim}

The reader will no doubt note that the 2013 version is far more prescriptive than the original, instrumentalizing the ‘nature of psychology as a discipline’ into the measurable ‘use basic psychological terminology, concepts and theories.’ It’s also notable that the phrase “ and mental processes” appears in three of the sub points, rather than just one. One might be tempted to assert that behaviorism is well and truly dead in Psychology. 

If the reader compares to the definitions offered by the various historical figures in the ‘\fullref{briefhistoryoftheapa}’ in the gamebook, you will no doubt recognize the theoretical pluralism embodied in that statement. My main for quoting this document is, however, the 2007 (a) and 2013 (1.1b).
...
Most Introduction to Psychology textbooks contain at least a nominal section addressing Goal 1. Many include a nod to history, noting Wundt, James, Freud and Pavlov. In this game, we introduce terminology, concepts and theories of psychology in a historical context: 
...
~\citep{Rathus:2012uz}&”Psychology, like other sciences, seeks to describe, explain, predict, and control the events it studies... ...behavior and mental processes.” (4)& Aristotle(8-9), Structuralism - Wundt (9), Functionalism - James (9-10), Behaviorism (10), Gestalt (10-11), Psychoanalysis (11-12)& \\
\caption{Timeline of critical events}
\label{table: timeline}
\end{longtable}
...
\begin{itemize}
\item Recognize that the historical contingency of the nature of our contemporary disciplines 

\item Identify and respond to historical examples at which debates about evidence shift into debates about the philosophy of science, and the legitimacy of evidence. (See examples in XX[ Peter Bradley, 7\slash 23\slash 18, 4:44 PM])
