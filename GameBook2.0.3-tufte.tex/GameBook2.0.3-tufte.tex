...
Presidential Address&\multicolumn{2}{| P{14cm} | }{Miller “Psychology as a means of promoting human welfare” \fullref{writingtask:miller}} \\ \hline

Symposia&“Psychiatry: Friend or Foe to Homosexuals: A Dialogue,” Fryer (\fullref{writingtask:fryer}), Hooker (\fullref{writingtask:hooker}), Kameny (\fullref{writingtask:kameny}) / Gittings (\fullref{writingtask:gittings}) &Worries about psychiatry, Szasz “The Myth of Mental Illness” \fullref{writingtask:szasz}, Marmor “Limits of Free Association” (\fullref{writingtask:marmor})\\ \hline

Proposals for the Board&Removal of homosexuality (Marmor '71)\newline
Create taskforce to study the history of treatment of homosexuality (proposed by Marmor, 1971)& Proposal from C. Socarides to create task force to sexual deviation.\newline
Proposal from J. Spiegel and R. Green to create task force of historical study and literature review of homosexuality in psychology and psychiatry. \fullref{johnspegielmd} -- Association Business.\\ \hline
Proposals for Research Committee&\multicolumn{2}{| P{14cm} | }{“Adjustment of Homosexual and Heterosexual Women”  \textbf{(proposed by Barbara Gittings, if in game, if not, gamemaster)}
\fullref{adjustmentofhomosexualandheterosexualwomen}\newline
“Emotional responses in a human child” \textbf{(proposed by gamemaster)} See \fullref{emotionalresponsesinahumanchild}). The original paper is available on psych classics:  http://psychclassics.yorku.ca/Watson/emotion.htm }\\ \hline
Research Reports&\multicolumn{2}{| P{14cm} | }{Miller, presenting Shepard, R. N., and Metzler, J. (1971). Mental rotation of three-dimensional objects. Science, 171, 701-703.} \\ \hline
...
Of course, the Little Albert experiment and Rosehan cannot be completed by actual students. If the research committee approves those experiments, the instructor should charge a student with presenting the original papers during the follow years' conference.

Students may recognize the ``little albert'' experiment, although I don't use the name `little albert' in the proposal. They will also probably find the experiment unethical. Many people do. My version of the proposed experiment contains no plan for deconditioning Albert. See the `Actual History' section below for a discussion of the history of this famous experiment.
...
Presidential Address&\multicolumn{2}{| P{14cm} | }{Bandura, “Behavioral theory and models of man”} \fullref{writingtask:bandura} \\ \hline

Symposia&On the ‘medical model’ Szasz \fullref{writingtask:szasz} and Albee (\fullref{writingtask:albee})& \\ \hline

Proposals for the Board& Proposal to recognize the contributions of Evelyn Hooker \(From Gebhard -- see \fullref{paulgebhard} -- Association Business\)\newline
...
Counter proposal from Albee to limit the role of psychiatrists to the admission of drugs. \newline Fordney-Settlage may be able to broker a compromise. (\fullref{dfordneysettlagemd} --- Association Business) \\ \hline
Proposals for Research Committee&\multicolumn{2}{| P{14cm} | }{“On being sane in insane places” \fullref{onbeingsaneininsaneplaces}\newline
Fordney Settlage (1973). [citation DS Fordney Settlage, Baroff S, Cooper D 1973. Sexual experience of younger teenage girls seeking contraceptive assistance for the first time. Family Planning Perspectives, Vol. 5, No. 4 Autumn, 1973, p 223-226] (available on Jstor)}  \\ \hline
Research Reports&\multicolumn{2}{| P{14cm} | }{Depending on outcome of 1971 proposals, one (or both) of Socarides on Sexual Deviation (\fullref{writingtask:socarides}) or Green (\fullref{writingtask:green}) and Spiegel (\fullref{writingtask:spiegel}) on history of homosexuality – responses from Bieber (\fullref{writingtask:beiber}), Marmor} \\ \hline
...
\begin{itemize}
\item Paper by Spitzer on Feighner Criteria \fullref{writingtask-spitzer}, Anastasi in support (\fullref{writingtask:anastasi})

\item Paper by Gebhard on the Kinsey report. \fullref{writingtask:gebhard}

\item Paper by Harlow “Lust, latency and love”
...
\begin{itemize}
\item Hopcke -- limit medical care of mentally distressed individuals in hospitals to licensed medical doctors\newline

\item Albee - limit the role of psychiatrists to the administration of drugs.
...
Proposals for the Board&Removal of homosexuality immediately (Spitzer '73) \fullref{robertspitzermd} \newline
Proposal from Free mtg create a journal titled *Archives of Sexual Behavior* \newline
Spitzer task force, dissolution of nomenclature committee (Spitzer, 1973)& (likely / possible):  Creation of the Society for the Psychology of Women (Anastasi, 1973) and Creation of the committee on Women in Psychology (Anastasi, 1973) \fullref{anneanastasi} \\ \hline
Proposals for Research Committee&\multicolumn{2}{| P{14cm} | }{Prison study (See \fullref{interpersonaldynamicsinasimulatedprison},  \textbf{(propsed by Zimbardo, if in game, if not, gamemaster)} \newline
“A re-analysis of the reliability of psychiatric diagnosis” (proposed by Spitzer \fullref{research-spitzer}) See \fullref{are-analysisofthereliabilityofpsychiatricdiagnosis}).}\\ \hline
Research Reports&\multicolumn{2}{| P{14cm} | }{Depending on outcome of 1972 proposals, one (or both) of “On being sane in insane places” and Fordney-Settlage “Sexual experience of younger teenage girls seeking contraceptive assistance for the first time.”\fullref{research-fordney}} \\ \hline
...
\begin{itemize}
\item Paper by Tyler on individual differences and their importance for counseling. \fullref{writingtask:tyler}

\item Symposium on “Should Homosexuality be in the APA Nomenclature” by the Nomenclature committee, with special power \textbackslash{}newline
...
\begin{itemize}
\item Marmor - official condemnation \slash  censure of Socarides JAMA paper as nonscientific and a “Monstorous attach on homosexuality."

\item Leona Tyler principle (See \fullref{leonatylerprinciple}).

\item Gold symposium on ``Stop! You're making me sick''
...
Symposia&TBD&TBD\\ \hline

Proposals for the Board&TBD& TBD \\ \hline
Proposals for Research Committee&\multicolumn{2}{| P{14cm} | }{Milgram 'small world' \textbf{proposed by Milgram if in game, if not gamemaster} See \fullref{smallworld} for sample proposal.  Original paper included in supplementary materials.) 
.}\\ \hline
Research Reports&\multicolumn{2}{| P{14cm} | }{Depending on outcome of 1973 proposals, one (or both) of Zimbardo “Prison study” and Spitzer “Re-analysis.”} \\ \hline
...
\item Chomsky \fullref{noamchomskyphd}---Social responsibility of scientists

\item Marmor

\end{itemize}

\item Milgram - Obedience

\item Lief - genetic hypothesis and diagnostic taxa. \fullref{writingtask:leif}

\end{itemize}

Open hearings \slash  symposium on the Spitzer def of ‘mental illness’.

\textbf{Other possible proposals}

Fryer - deem aversion therapy to treat homosexuality immoral. In opposition: Harlow.
...
Research Reports&\multicolumn{2}{| P{14cm} | }{Depending on outcome of 1974 proposals, Migram “small world”} \\ \hline
\caption{Major events of 1974}
\end{longtable}
...
\item Open forum on definition of mental illness (called by Nomenclature \slash  Spitzer Task Force) (See \fullref{robertspitzermd} - Definition of ‘mental illness’.
...
An Experimental Study of the Small World Problem. (1969). An Experimental Study of the Small World Problem, 32(4), 425–443. http:\slash \slash doi.org\slash 10.2307\slash 2786545?refreqid=search-gateway:a88fe1dd7db6336d575e302c0c15221e
\newpage
...
\listoftheorems[ignoreall,show={mycommittees,myassign,myresearch}]
...
Organize a symposium with Thomas Szasz on the suitability of the medical model for psychiatric treatment. This will be best in 1972 before the debate on the DSM-III gets moving in 1973.\begin{writingtask}[Albee - 1972]\label{writingtask:albee}
...
There will likely be a proposal to limit the treatment of mentally disordered patients to psychiatrists, you should not only fight against it, but propose a separate system of treatment run entirely by psychologists. Your proposal should call for the establishment of various centers that would train, certify and deliver mental health services, in competition with psychiatry. Check out \fullref{sample: APAEthics1968}, point e, which was added in 1968. You should work to get this removed or changed so psychologists can also work with psychotropics in their practice.
...
\begin{writingtask}[Anastasi - 1972]\label{writingtask:anastasi}
...
During the time that the DSM-III revisions are taking place, you should run for president and propose two new standing committees of the APA. It is important to gain support of the other women of the APA in making these proposals.
...
As you straddle the fence between the MD and PhDs, the Medical doctors and the Psychologists, you are in the unique position to create a compromise between Albee and Spitzer regarding the rights and duties of the psychologists and psychiatrists in the treatment of patients in 1972.
...
Help organize a symposium in 1973 on the topic of “Should Homosexuality Be in the APA Nomenclature?” Green, Marmor, Bieber, Socarides and Spitzer should speak.
...
Present a version of your argument in *Myth of Mental Illness* in 1971. This is already on the schedule, so you should get working now. Also, hold a symposium with Albee in 1972.
\end{writingtask}
...
\begin{writingtask}[Bieber]\label{writingtask:anastasi}
...
present your paper “Limitations of Free Association” to the population. The paper is available in Arch. Gen. Psychiat. 22:160-165, 1970. You should read it, and present and defend the data in character.
\end{writingtask}
...
As a member of the Young Turks, you are dedicated to the demedicalization of homosexuality. If Armor’s initial proposal to remove homosexuality fails, you will work with Green to create a task force to conduct a historical survey of the literature on homosexuality. See ‘Research’ for more info.
