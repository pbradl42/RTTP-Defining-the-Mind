...
\begin{itemize}
\item Experimental Study of the Small World Problem. (1969). An Experimental Study of the Small World Problem, 32(4), 425–443. \url{http://doi.org/10.2307/2786545?refreqid=search-gateway:a88fe1dd7db6336d575e302c0c15221e} Included as \fullref{smallworld} in the Instructor's Manual.
...
\end{center}
 \caption{Advertisement for Librium, 1962. From \url{https://www.mmm-online.com/channel/med-ad-hall-of-fame-to-induct-lerner-girgenti-and-rubin/article/155796/}
}
\label{fig: valium65}
\end{marginfigure} 
...
From \url{http://faculty.weber.edu/ewalker/Medicinal_Chemistry/topics/Psycho/psycho.htm}
...
\end{center}
 \caption{Advertisement for Blue Cross, 1960. From \url{http://www.decodog.com/inven/MD/md28530.jpg} }
\label{fig: BlueCross}
\end{marginfigure}
...
K. Clark&
Phillips, L. “Recontextualizing Kenneth B. Clark: An Afrocentric Perspective on the Paradoxial Legacy of a Model Psychologist-Activist” from Evolving Perspectives on the History of Psychology, Pinkren, W and Dewsbury, D.
\newline
...
J. Piaget&Piatelli-Palmarini, M. (Ed.) (1980). Language and Learning: The Debate between Jean Piaget and Noam Chomsky, London: Routledge \& Kegan Paul . Reviewed at: \url{http://journals.cambridge.org/action/displayAbstract?fromPage=online&aid=5843312}
\\ \hline
...
J. Spiegel \&Grinker, R. & Spiegel, J. P. (1945) Men Under Stress American Psychological Association. Was once available print-on-demand, but is not currently: \url{www.apa.org/pubs/books/4320127.aspx}
\\ \hline
...
Before the game begins, the credibility of each character ought to be established. The values displayed in table \fullref{table: initialcredibility} are on the top of each individual’s game sheet. It is important, however, for everyone in the game to know how much credibility the various players have. To that end, it is advisable for the game master to start the game by publicly distributing the actual ‘credibility tokens’ (\fullref{credibilitypoints}) during the start of the first class, announcing who has what credibility.
 ...
 \begin{longtable}[!t]{ | P{3.4cm} | P{6.5cm} | }
\hline 
