...
\end{center}
 \caption{‘Homophile’ activists picketing in 1965. From \url{http://bilerico.lgbtqnation.com/}}
...
\end{center}
 \caption{‘Penalties for Sex Offenses’, a Pamphlet distributed by the Mattachine Society in 1964 to educate its members.  From \url{http://web-static.nypl.org/exhibitions/1969/ref/1696842.html}}
...
\end{center}
 \caption{Rules for Picketing. From the Kameny papers website: \url{http://www.kamenypapers.org/memorabilia.htm}, collected 7/14/2016}
...
Sample call for research grants.\footnote{This section adapts language from the mission statements of the contemporary APA (\url{http://www.apa.org/about/})}
...
The DSMI’s “Revised Nomenclature” is 39 pages long (Included as Appendix \fullref{app: DSMI}). The DSMII’s is 40 pages long (Included as Appendix \fullref{app: DSMII}). The equivalent section (2) of the DSMIII is 300 pages long. The DSMIII-R added another 250 pages or so and the DSMIV another 100. Since then, the DSM IV-TR and the DSM V have continued to grow. There is as massive difference in scale in these versions, but it is the difference \emph{in kind} between the taxonomy used in early DSMs and III that interests us in this game. And while that taxonomy has grown since the III, it has not changed in nature.

\newthought{We do not expect} undergraduate students to produce a diagnostic taxonomy in this game. Rather, we are expecting students to determine upon what basis such a diagnostic taxonomy should be based: observable symptoms or hypothetical causes. These are questions of Philosophy, not necessarily questions of Psychology or Psychiatry. And we throw in Thomas Szasz and his sympathizers to drive home the importance of having a definition in the first place.
...
Well-known publications by each character are included in Section \fullref{briefsketchofthegamecharacters} of the gamebook.
...
Legitimacy&Student raises, or preemptively addresses (depending on role), questions  regarding the legitimacy of evidence. (See \fullref{table: learninggoals} 2) & Student recognizes questions of legitimacy but does not raise or address them & Student accepts all evidence as legitimate. \\ \hline

Context&Where appropriate, student is able to contextualize views under discussion into their historical context (See \fullref{table: learninggoals} 1 and 4). & Student recognizes context, but does not use it in analyses. & Student treats all theories as authoriative\\ \hline

Primary sources&Student uses historically appropriate primary sources (See \fullref{table: learninggoals} 5) & Student cites historically appropriate primary sources, but does not engage with them & Student does not include historically appropriate primary sources -- sources not primary, or not historically appropriately. \\ \hline

Implications&Student is able to distinguish between the major theoretical positions represented in the game, and interpret evidence as bearing on those positions in some way. (\fullref{table: learninggoals} 6) & Student can ‘rehearse/ distinctions between theoretical positions, but cannot connect theories with evidence& Student mistakes or confuses theoretical positions.\\ \hline
...
\item Proposals for the research committee (Table \fullref{table: labs}), if there are no proposals from students.

\item The primary source of any historical studies (Table \fullref{historicalstudies}) of experiment that will be reported.
...
Proposals for the Board&Removal of homosexuality (\fullref{proposal:marmorA} of the Role Sheet book)\newline
 & \begin{itemize}
\item{Proposal from C. Socarides to create task force on sexual deviation. (\fullref{proposal:socarides} of the Role Sheet book)}
...
\item{“Emotional responses in a human child” (proposed by \textbf{ gamemaster}). Sample is included as \fullref{emotionalresponsesinahumanchild.} of the Instructor's Manual. The original paper is available on psych classics:  \url{http://psychclassics.yorku.ca/Watson/emotion.htm} }\end{itemize}}\\ \hline
...
Of course, the Little Albert experiment cannot be completed by actual students. If the research committee approves the experiments, the instructor should charge a student with presenting the original papers during the following years' conference.
...
\item{Proposal from Fordney-Settlage to study the sexual experience of teenage girls seeking contraception for the first time (\fullref{researchtask:fordneysettlage} in the Role Sheet book).}\end{itemize}}  \\ \hline
...
\item{Distribute the actual report of the ‘Little Albert’ experiment. Paper is available on psych classics: \url{http://psychclassics.yorku.ca/Watson/emotion.htm} }
...
\begin{itemize}
\item Siegelman, “Adjustment of Homosexual and Heterosexual Women” The British Journal of Psychiatry (1972) 120: 477--481. Included in appendix as \fullref{adjustmentofhomosexualandheterosexualwomen} in the Instructor's Manual.
...
Proposals for Research Committee&\multicolumn{2}{| P{14cm} | }{\begin{itemize}
\item{Prison study. Included in appendix as  \fullref{interpersonaldynamicsinasimulatedprison} in the Instructor's Manual.  (proposed by Zimbardo, if in game, if not, \textbf{gamemaster})  (\fullref{researchtask:zimbardo} in the Role Sheet book)}
\item{“A re-analysis of the reliability of psychiatric diagnosis,” Included in appendix as \fullref{are-analysisofthereliabilityofpsychiatricdiagnosis} of the Instructor's Manual. (proposed by \fullref{researchtask:spitzer}) .} \end{itemize}}\\ \hline
...
\begin{itemize}
\item Marmor - if not in 1972: official condemnation \slash  censure of Socarides JAMA paper as nonscientific and a “Monstorous attack on homosexuality." (\fullref{proposal:marmorB} of the Role Sheet book)
...
\begin{itemize}
\item Rosenhan `On being sane in insane places' Science v.. 179 (Jan. 1973), 250--258. Included in appendix as \fullref{onbeingsaneininsaneplaces} in the Instructor's Manual.
...
\subsection{Sample Conference Schedule for 1974}
\label{sampleconferenceschedulefor1974}
...
\begin{itemize}
\item Deem[ Peter Bradley, 9\slash 30\slash 18, 5:50 PM] aversion therapy to treat homosexuality immoral. \fullref{proposal:fryer}
...
\begin{itemize}
\item Haney, C. Banks, C. \& Zimbardo, P. (1973). “Interpersonal Dynamics in a Simulated Prison,” International Journal of Criminology and Penology 1, p. 69--97, Included in appendix as \fullref{interpersonaldynamicsinasimulatedprison} in the Instructor's Manual.
...
\begin{itemize}
\item Spitzer, R. and Fleiss, J. (1974). “A Re-analysis of the Reliability of Psychiatric Diagnosis” Brit. J. Psychiat. 125, 341--7. Included in appendix as \fullref{are-analysisofthereliabilityofpsychiatricdiagnosis} in the Instructor's Manual.
...
\item Symposium on ‘innateness’ between Piaget (\fullref{writingtask:piaget}) and Chomsky (\fullref{writingtask:chomsky} ) with implications for social responsibility and homosexuality.
...
\begin{itemize}
\item Experimental Study of the Small World Problem. (1969). An Experimental Study of the Small World Problem, 32(4), 425–443. \url{http://doi.org/10.2307/2786545?refreqid=search-gateway:a88fe1dd7db6336d575e302c0c15221e} Included in appendix as \fullref{smallworld} in the Instructor's Manual.
...
\rowgroup{This statement was prepared by the Committee of Black Psychiatrists and recommended by the Council on National Affairs } \\
...
In many ways, this is not a game about Psychology or Psychiatry, it is a game about the Philosophy of Science. This shouldn't really be surprising, as the history of Psychology and Psychiatry is intimately linked to the history of Philosophy of Science. Arguments made by Wundt, Freud, Watson, Hull Skinner and Miller all rely heavily on claims regarding what is or is not a legitimate scientific claim.\footnote{See, e.g. Wundt (1902, pg 5--6) Freud XX, Watson (Mathematical paper), Skinner XX, Hull, (1935), Miller (citing Suppes)} This issue has not disappeared from undergraduate Psychological classroom either. The APA's guidelines for the Undergraduate Major in Psychology, published 2007, lists 10 learning outcomes for a major. The first is in box \fullref{excerptfromapaguidelinesforanundergraduatemajorinpsychology2007}, and the second in \fullref{excerptfromapaguidelinesforanundergraduatemajorinpsychology2.02013}.
...
3.3 Apply their understanding of paradigm cases like Newton’s \emph{Experimentum Crucis}, and Hermann Ebbinghaus’ memory experiments as \emph{the} paradigm of experimental psychology, to judge the validity of new and novel research proposals. \\
...
\item Demonstrate a working knowledge of the major distinctions in the study of the mind: psychodynamic, behavioristic and cognitive, including being able to correctly categorize major views \slash  works, and discuss the complexity of cases on the margins (i.e. Tolman, Bandura) \\
...
\item Social Psychology: Milgrim and Zimbardo --- two labs: Zimbardo proposes \fullref{interpersonaldynamicsinasimulatedprison} to Research committee and, if time allows, \fullref{smallworld} from Milgrim.)

\item Statistical concepts: Hooker’s paper (~\citep{Psychology:tf}) sets the stage, but it will reappear in the game play of Anastasi and Spitzer. Spitzer’s presentation on the Feighner Criteria should cover statistical concepts. Anastasi should present a paper about ‘norms’ and whether ‘normal’ is a statistical function of a population, or an ideal. Lab: \fullref{are-analysisofthereliabilityofpsychiatricdiagnosis}
...
\item Modeling in scientific inquiry---Section \fullref{modelsinscience}. Lab: \fullref{mentalrotationofthree-dimensionalobjects}.

\item Complications of observation --- Section \fullref{observationalresearch}. Lab: \fullref{onbeingsaneininsaneplaces}.
...
1973 Nomenclature Sympoisum. Include \fullref{writingtask:goldA} \\ \hline
...
Before the game begins, the credibility of each character ought to be established. The values displayed in table \fullref{table: initialcredibility} are on the top of each individual’s game sheet. It is important, however, for everyone in the game to know how much credibility the various players have. To that end, it is advisable for the game master to start the game by publicly distributing the actual ‘credibility tokens’ (\fullref{credibilitypoints}) during the start of the first class, announcing who has what credibility.

 \begin{longtable}[!t]{ | P{4cm} | P{1.5cm} | }
\hline 
\tahead{Name}&\tahead{Initial Credibility} \\ \hline
...
Contrary to most textbooks that repeat the myth that `Little Albert' was successfully deconditioned by Watson and was adopted by a family in North Baltimore and went on to live a long, happy, normal life, there is recent evidence to suggest that Little Albert died as a child. 
...
In the role sheet for Spitzer, I express some doubts about the standard story told by Spiegel, because Spitzer's timing and motivation for inserting himself into the controversy doesn't seem to match up for a normal person. However, as I was to learn, Spitzer is not a `normal' person.
...
See discussion of NARTH in \fullref{demedicalization} above.
...
E. Hooker was given the 1991 Award for Distinguished Contribution to Psychology in the Public Interest, presented by the American Psychological Association. The citation read:
...
\includepdf[pages={1-}]{../charactersResources/GMiller/1971-ShepardAndMetzler.pdf}

\subsection{Adjustment of Homosexual and Heterosexual Women}
\label{adjustmentofhomosexualandheterosexualwomen}

\label{paper: observation}
\includepdf[pages={1-}]{../charactersResources/BGittings/1972-Siegelman-AdjustmentofHomosexualWomen.pdf}

\subsection{On being sane in insane places}
\label{onbeingsaneininsaneplaces}

\label{paper: rosenhan}
\includepdf[pages={1-}]{../PrimarySourceMaterials/1973-Rosenhan-OnBeingSaneInInsanePlaces.pdf}

\subsection{Interpersonal Dynamics in a Simulated Prison}
\label{interpersonaldynamicsinasimulatedprison}

\label{paper: zimbardo}
\includepdf[pages={1-}]{../charactersResources/PZimbardo/1973-Zimbardo-InternationalJournalofCriminologyandPenology1973Haney.pdf}

\subsection{A Re-analysis of the Reliability of Psychiatric Diagnosis}
\label{are-analysisofthereliabilityofpsychiatricdiagnosis}

\label{paper: spitzer}
\includepdf[pages={1-}]{../charactersResources/RSpitzer/1974-SpitzerAndFleiss341.pdf}
...
For a brief history see Pinsker, H. (2007). “Goldwater Rule' History”, Psychiatric News, 42 (15), p. 33 (\url{http://pn.psychiatryonline.org/content/42/15/33.1.full})} (see the gamebook \fullref{playingapsychologistorpsychiatristinthe1970s.}, and anticipates the problems associated with the APA’s stand on abortion in 1970s:
