...
\rowgroup{3. The idea of the appearance a ‘disturbing intention’ (Lecture III, pg. 63--72) and the relation between the ‘disturbing intention’ and the ‘disturbed one’ (p. 75--78)---which sets the stage for his mechanisms of representation (see \fullref{mechanismsofrepresentation}).} \\

\rowgroup{4. The Dynamic hypothesis (p. 82 and again p. 94) (Thesis \#1 in \fullref{classical}).} \\

\tahead{Class 2: Dreams (Lectures 5--15)} \\

\rowgroup{1. Transformations (I.e. ‘Mechanisms of representation’ in Dream-work) in Lecture 11: Condensation (p. 210--214), Displacement (214--215), Plastic portrayal (215--219), Opposition (219--223). (see \fullref{mechanismsofrepresentation})} \\
...
Propose, with Green, a task force on the history of the treatment of homosexuality (\fullref{proposal:spiegel }). \newline Report on history of homosexuality '72 (with R. Green) \fullref{writingtask:spiegel}
...
Propose, with Green, a task force on the history of the treatment of homosexuality (\fullref{proposal:spiegel }). \newline Report on history of homosexuality '72 (with R. Green) \fullref{writingtask:spiegel}
If elected, Presidential address '75&
Taskforce on the history of homosexuality in Psych '71 (with Green)& Defense Mechanism \fullref{researchtask:spiegel}
\\ \hline
...
\item 1975: Lab: \fullref{smalworld}
