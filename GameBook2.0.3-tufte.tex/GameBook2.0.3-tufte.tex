...
Factions in this game are relative `loose.' The basic theoretical frameworks in place have factional alignment, but there are plenty of independents who `lean' towards one or more factions.
...
\begin{itemize}
\item Solicit proposals in the form of a `call for research grants' --- an example is included in \fullref{callforesearchgrants} in the Game Book.
...
Objective: understand how theory change is driven by evidence.
...
\item Proposals for the research committee (\fullref{labandpossibleresearchproposals}), if there are no proposals from students.

\item The primary source of any \fullref{weeklyreadings} of experiment “approved” in the week prior.
...
As noted elsewhere, there a few narrative threads that are meant to reinforce each other as the game progresses. The game as two basic ‘modalities’ of play: political and research. These are orchestrated to be mutually reinforcing, where lab experiences inform discussion of policy, and questions about policy drive research. That all depends, of course, on timing. And timing in a reacting game is unpredictable.
...
\textbackslash{}newthought\{The Political:\}. The dominant narrative of the game starts with Marmor’s shocking and radical proposal to drop Homosexuality (302.0) from the DSM-II in 1971. This is met with a counter-proposal from Socarides \slash  Bieber to study the whole taxonomy of 302 (‘Sexual Deviations’) and report back with a proposal of their own. \emph{That} is met with a counter proposal from Spiegel and Green to study the history and effectiveness of ’treatment’ of homosexuals. 
...
George Miller has heavy initial load --- assign a student who can set the tone for everybody.
...
Proposals for the Board&Removal of homosexuality (\fullref{proposal:marmorA}of the Role Sheet book)\newline
 & Proposal from C. Socarides to create task force to sexual deviation. (\fullref{proposal:socarides} of the Role Sheet book)\newline
Proposal from J. Spiegel and R. Green to create task force to conduct a study of the history of the treatment of homosexuality in psychology and psychiatry. (\fullref{proposal:spiegel} and \fullref{proposal:green} of the Role Sheet book) \\ \hline
Proposals for Research Committee&\multicolumn{2}{| P{14cm} | }{“Adjustment of Homosexual and Heterosexual Women”  (\fullref{researchtask:gittings}) (proposed by Barbara Gittings, if in game, if not, \textbf{gamemaster)}). Sample is included as 
\fullref{adjustmentofhomosexualandheterosexualwomen} of the Instructor's Manual.\newline
“Emotional responses in a human child” (proposed by \textbf{ gamemaster}). Sample is included as \fullref{emotionalresponsesinahumanchild.} of the Instructor's Manual. The original paper is available on psych classics:  http://psychclassics.yorku.ca/Watson/emotion.htm }\\ \hline
Research Reports&\multicolumn{2}{| P{14cm} | }{Miller (\fullref{researchtask:miller}), presenting Shepard, R. N., and Metzler, J. (1971). Mental rotation of three-dimensional objects. Science, 171, 701-703. Paper included in the Appendix as \fullref{paper: mentalrotation} of the Instructor's Manual. } \\ \hline
...
\subsubsection{Research committee proposals}
\label{researchcommitteeproposals}

Unless otherwise noted, these should be brought to the research committee for discussion \textbf{by the gamemaster.} If Milgram and Zimbardo are not in the game, those will need to be brought as well. The actual papers should be made available to the students who will be presenting the data, if the activities are not actually performed.

\begin{itemize}
\item Shepard \& Metzler's `mental rotation of three-dimensional objects' task was approved “in 1970”, so the task should be presented to the students, and Miller prepped on presenting the data (See \fullref{mentalrotationofthree-dimensionalobjects}. )You will need to register for an account here: http:\slash \slash opl.apa.org\slash Experiments\slash About\slash AboutMentalRotation.aspx to use the APA’s version.
...
Proposals for the Board& Proposal to recognize the contributions of Evelyn Hooker (from Gebhard---See \fullref{proposal:gebhard})\newline
& Proposal from Nomenclature Committee to write a new DSM according to description of symptoms, not causes (Pro: \fullref{proposal:spitzerA} and Opposed: \fullref{proposal:lief})\newline
Proposal from Hopcke to limit medical care of mentally distressed individuals in hospitals to licensed medical doctors (i.e. psychiatrists) (\fullref{proposal:hopcke} of the Role Sheet book) \newline
Counter proposal from Albee to limit the role of psychiatrists to the admission of drugs. (\fullref{proposal:albee} in the Role Sheet book)\newline 
Fordney-Settlage may be able to broker a compromise. (\fullref{proposal:fordneysettlage} in the Role Sheet Book) \\ \hline
Proposals for Research Committee&\multicolumn{2}{| P{14cm} | }{“On being sane in insane places” included as \fullref{onbeingsaneininsaneplaces} (proposed by \fullref{researchtask:szasz} in the Role Sheet book, or, if not in game, \textbf{gamemaster})\newline
Proposal from Fordney-Settlage to study the sexual experience of girls seeking contraception for the first time (\fullref{researchtask:fordneysettlage} in the Role Sheet book).}  \\ \hline
Research Reports&\multicolumn{2}{| P{14cm} | }{Depending on outcome of 1971 proposals, one (or both) of Socarides on Sexual Deviation (\fullref{writingtask:socarides}) or Green (\fullref{writingtask:green}) and Spiegel (\fullref{writingtask:spiegel}) on history of homosexuality – responses from Bieber (\fullref{writingtask:bieber}), Marmor} \\ \hline
...
\begin{itemize}
\item 1972---Following approval of \fullref{researchtask:gittings} of the Role Sheet book:
...
Presidential Address&\multicolumn{2}{| P{14cm} | }{Depends on previous elections} \\ \hline

Symposium&\multicolumn{2}{| P{14cm} | }{Nomenclature committee-organized open panel discussion of the proposed removal of 'Homosexuality' from 302.00.}\\ \hline

Proposals for the Board&Removal of homosexuality immediately (\fullref{proposal:spitzerB} of the Role Sheet Book) \newline
Proposal from Green create a journal titled emph{Archives of Sexual Behavior} (\fullref{proposal:greenB} in the Role Sheet book)\newline
Spitzer task force, dissolution of nomenclature committee (\fullref{proposal:spitzerB} of the Role Sheet book.)& (likely / possible):  Creation of the committee on Women in Psychology (\fullref{proposal:anastasiA} in the Role Sheet book) and creation of the Society for the Psychology of Women (\fullref{proposal:anastasiB} in the Role Sheet Book) and  \\ \hline
Proposals for Research Committee&\multicolumn{2}{| P{14cm} | }{Prison study. Included as  \fullref{interpersonaldynamicsinasimulatedprison} in the Instructor's Manual.  (proposed by Zimbardo, if in game, if not, \textbf{gamemaster})  (\fullref{researchtask:zimbardo} in the Role Sheet book)\newline
“A re-analysis of the reliability of psychiatric diagnosis” Included as \fullref{are-analysisofthereliabilityofpsychiatricdiagnosis} of the Instructor's Manual. (proposed by Spitzer \fullref{researchtask:spitzer}) .}\\ \hline
Research Reports&\multicolumn{2}{| P{14cm} | }{Depending on outcome of 1972 proposals, one (or both) of Szasz, “On being sane in insane places” (\fullref{researchtask:szasz} in the Role Sheet book) and Fordney-Settlage “Sexual experience of younger teenage girls seeking contraceptive assistance for the first time.” (\fullref{researchtask:fordneysettlage} in the Role Sheet book)} \\ \hline
...
\item Symposium \slash  discussion on “Should Homosexuality be in the APA Nomenclature” by the Nomenclature committee, with special power. Includes

\begin{itemize}
\item \fullref{writingtask:goldA} of the Role Sheet book.

\item Kameny\slash Gittings, Green, Spitzer and Socarides\slash Bieber to be panelists, but they will speak extemporaneously, not deliver formal papers.
...
\begin{itemize}
\item Marmor - official condemnation \slash  censure of Socarides JAMA paper as nonscientific and a “Monstorous attach on homosexuality." (\fullref{proposal: marmorB} of the Role Sheet book)
...
\item 1973---Following approval of \fullref{researchtask:szasz} of the Role Sheet book:
...
Proposals for Research Committee&\multicolumn{2}{| P{14cm} | }{Proposal from Milgram (\fullref{researchtask:milgram} in the Role Sheet book). If Milgram is not a character, proposal should come from \textbf{gamemaster} See \fullref{smallworld} for sample proposal.  Original paper included in supplementary materials on GitHub.) \newline
Proposal from Fryer to replicate Rosenhan in the classroom (\fullref{researchtask:fryer}).
.}\\ \hline
Research Reports&\multicolumn{2}{| P{14cm} | }{Depending on outcome of 1973 proposals, one (or both) of \fullref{researchtask:zimbardo} and \fullref{researchtask:spizter}} \\ \hline
...
\begin{itemize}
\item Clark \fullref{writingtask:clark}

\item Chomsky \fullref{writingtask:chomskyB}---Social responsibility of scientists

\end{itemize}

\item Milgram - \fullref{writingtask:milgram}

\item Lief - genetic hypothesis and diagnostic taxa. \fullref{writingtask:leif}
...
Fryer - deem aversion therapy to treat homosexuality immoral. \fullref{proposal:fryer}
In opposition: Harlow.

\textbf{Papers to be distributed (if activities are approved)}

\begin{itemize}
\item 1974---Following approval of \fullref{researchtask:zimbardo} of the Role Sheet book:
...
\item 1974---Following approval of \fullref{researchtask:spitzer} of the Role Sheet book

\begin{itemize}
\item Spitzer, R. and Fleiss, J. (1974). “A Re-analysis of the Reliability of Psychiatric Diagnosis” Brit. J. Psychiat. 125, 341--7 Included as $<$!--\textbackslash{}fullref\{are-analysisofthereliabilityofpsychiatricdiagnosis\} in the Instructor's Manual.
...
\begin{itemize}
\item Clark \slash  Anastasia \slash  Spiegel on statistical structures of ‘normal’ in the the DSM-III taxa.

\item Open forum on definition of mental illness (called by Nomenclature \slash  Spitzer Task Force) (See \fullref{proposal:spitzerD} - Definition of ‘mental illness’.
...
\begin{itemize}
\item 1975---Following approval of \fullref{researchtask:milgram}:
...
Access to Mental Rotation Task

Hard copies of:

\begin{itemize}
\item Sample conference schedule (Section \fullref{scheduleforfirstconference} of the instructor's manual).

\item Sample Call for Papers and Symposia (Section \fullref{callforpapersandsymposia} of the game book).

\item Sample call for research grants (Section \fullref{callforresearchgrants} of the game book).

\item Papers to be distributed (see table \fullref{table: possiblelabactivities} of the instructor's manual)
...
\begin{itemize}
\item Conditioning: classical, operant and vicarious: Section \fullref{behaviorists}, articulated by Bandura, Harlow and Hooker. Specific experiments to be considered include Lab \fullref{emotionalresponsesinachild}
...
Some of these issues that will make an appearance in the game are:
 ...
 \begin{longtable}[!t]{ | P{5cm} | P{2cm} |  P{10cm} | }
\hline

\tahead{Issue}&\tahead{Partisans}&\tahead{Session} \\ \hline \hline
Homosexuality \emph{is / is not} a mental disorder&Spitzer, Socarides, Bieber, Marmor& 1971 \fullref{proposal:marmor}\newline
...
1973 Nomenclature Sumpoisum. Include \fullref{writingtask:gold} \\ \hline
...
1973 \fullref{researchtask:spitzer} and \fullref{researchtask:marmor} \newline
 \\ \hline
Mental disorders should be classified according to \emph{observable symptoms / underlying mechanisms}.&Spitzer and the behaviorists v. psychoanalyst faction&1972 \fullref{writingtask:spitzer}, \fullref{writingtask:anastasi} and \fullref{writingtask:lief} \\ \hline
...
1973 \fullref{researchtask:zimbardo} \\ \hline
...
Nomenclature expiring ’72 \newline
Board member ‘At large B' '71-'72*} \fullref{service:albee} \\&
Parallel medical system for clinical psychology '72&
'Medical Model' – symposium '72 \fullref{writingtask:albee}
\\ \hline
\multicolumn{3}{| P{16cm} |}{ \tahead{A. Anastasi}---Program '71-'73 \fullref{service:anastasi}} \\
...
\multicolumn{3}{| P{16cm} |}{\tahead{I. Bieber}} \\
Comment on Green / debate Marmor '72\newline
Report on sexual deviation (Freudian) '73 \fullref{writingtask:beiber}
...
\multicolumn{3}{| P{16cm} |}{\tahead{N. Chomsky}} \\
...
\multicolumn{3}{| P{16cm} |}{\tahead{K. Clark}---Research '71-'73 \fullref{service:clark}} \\
...
\multicolumn{3}{| P{16cm} |}{\tahead{D. Fordney Settlage}*}\\
...
Sexual experiences of younger women seeking contraceptives. '73 (See \fullref{dfordneysettlagemd} - Research \\ \hline

\multicolumn{3}{| P{16cm} |}{\tahead{J. Fryer}} \\
...
\multicolumn{3}{| P{16cm} |}{\tahead{P. Gebhard}--- Program '71-'74} \\
Summary of the Kinsey report '72 \fullref{writingtask:gebhard}&
Honor of E. Hooker '72 (See\fullref{paulgebhardphd}--Association Business&
\\ \hline

\multicolumn{3}{| P{16cm} |}{\tahead{R. Gold}*} \\
Symposium on nomenclature '73&
Support Marmor's '71 proposal\newline
Draft proposal with Spitzer '73&
\\ \hline

\multicolumn{3}{| P{16cm} |}{\tahead{R. Green}*} \\
...
\multicolumn{3}{| P{16cm} |}{\tahead{H. Harlow}---Board '71 \fullref{service:harlow}} \\
...
\multicolumn{3}{| P{16cm} |}{\tahead{E. Hooker}---Program \fullref{service:hooker} ’71-'72}\\
...
\multicolumn{3}{| P{16cm} |}{\tahead{R. Hopcke}*} \\
Jungian approaches to homosexuality '75 \fullref{writingtask:hopcke}&
Support the proposal to limit care of mental illness to MDs ’72&
\\ \hline

\multicolumn{3}{| P{16cm} |}{\tahead{B. Gittings}*} \\
...
\multicolumn{3}{| P{16cm} |}{\tahead{F. Kameny}*} \\
...
\multicolumn{3}{| P{16cm} |}{\tahead{H. Lief}} \\
Paper on genetic hypothesis and diagnostic taxa '74 (\fullref{writingtask:leif})&
Oppose Spitzer's nomenclature proposal in defense of the genetic hypothesis '72&
\\ \hline

\multicolumn{3}{| P{16cm} |}{\tahead{J. Marmor}---Research '71-'74}\\
“Limitations of Free Association” - paper '71 \fullref{writingtask:marmor} \newline
...
APA \fullref{app:tosleep} (\fullref{researchtask:marmor})\\ \hline

\multicolumn{3}{| P{16cm} |}{\tahead{D. Marr*}} \\
...
\multicolumn{3}{| P{16cm} |}{\tahead{S. Milgram}*--Board member ‘A’*}\\
...
\multicolumn{3}{| P{16cm} |}{\tahead{G. Miller}---Board '71-'72} \\
“Psychology as a means of promoting human welfare” - '71&
'72 – reject Bieber&
Present Mental Rotation '71 (Shepard / class data)\\ \hline

\multicolumn{3}{| P{16cm} |}{\tahead{J. Piaget}*} \\
Debate with Chomsky '75 \fullref{writingtask:piaget}&
&
\\ \hline
\multicolumn{3}{| P{16cm} |}{\tahead{L. Tyler}---Research '71-'72 \fullref{service:tyler}} \\
...
\multicolumn{3}{| P{16cm} |}{\tahead{J. Spiegel}---Nomenclature '71-'74 \fullref{service:spiegel}} \\
...
Symposium on nomenclature '73\newline
With the task force, open symposium in ’74 on mental illness&
As nomenclature committee: write DSM according to description of symptoms, not causes '72
AND proposal to disband nomenclature and form Spitzer Taskforce '73\newline
With R. Gold, draft proposal to remove 'homosexuality' immediately in '73
Reliability of psychiatric diagnosis '73\\ \hline

\multicolumn{3}{| P{16cm} |}{\tahead{T. Szasz}} \\ 
“The myth of mental illness” - paper '71 \fullref{writingtask:szasz} \newline
Symposium (with Albee) “Medical Model” -  symposium '72&
Oppose committee on psychology of women '73 (on grounds of reification of the term 'women’)&
\\ \hline

\multicolumn{3}{| P{16cm} |}{\tahead{P. Zimbardo}*} \\
Paper on the ethical problems of Zimbardo '73, \newline and any holes in the APA guidelines.  \fullref{writingtask:zimbardo} ’75&
&
...
Limitation of care to hospital settings and psychiatrists 1972&Hopcke&Albee&&\fullref{writing task:albee} \\ \hline
New DSM -1973&Spitzer / Nomenclature& & & \\ \hline
Ban Aversion Therapy in the treatment of homosexuality&Fryer&&& \\ \hline
Affirmative Action - 1975&Clark&Milgram& &Clark Presidential Address (\fullref{writingtask:clark}) or symposium \fullref{writingtask:clark2} \\ \hline
Leona Tyler principle - 1974&Tyler&Chomsky, Clark&&\fullref{writingtask:chomsky} \\ \hline
...
\label{committeespublicationsandexhibits}
 ...
 \begin{longtable}[!t]{ | p{1cm} | p{4cm} | p{4cm} |  p{4cm} | p{4cm} | }
\hline
year&
Board of Directors&
Research Committee&
...
\emph{Approve} taskforces for Green (\fullref{proposal:green}) and Bieber (\fullref{proposal:bieber}) &
Administer ‘\fullref{mentalrotationofthree-dimensionalobjects}’---Miller will report in 1972. \newline
\emph{Approve} \fullref{research task:gittings}, \emph{reject }\fullref{emotionalresponsesinahumanchild.}&
...
\emph{approve} \fullref{researchtask:szasz}, \fullref{researchtask:fordneysettlage} &
...
Spitzer’s proposals \fullref{proposal: spitzerB} and \fullref{proposal:spitzerC}, send \fullref{proposal: spitzerB} to vote of the membership\newline
Leona Tyler Principle \fullref{proposal:tyler}&
Approve \fullref{researchtask:zimbardo}, \fullref{researchtask:spitzer}&
...
\emph{bar} Aversion therapy \fullref{proposal:fryer}&
\emph{approve} \fullref{researchtask:milgram} &
\emph{dissolved}---or hold open session on def. of ‘mental illness’&
...
\subsection{Managing Discussion}
...
I've pulled a number of experiments from the APA's \emph{Activities Handbook for the Teaching of Psychology} v. 1--4 that correspond to many of the topics the class will be discussing. They are listed here, and attached as PDFs at the end of this document, if you do not have access to the \emph{Handbooks}. The characters listed here are \emph{suggestions}. The instructor should distribute these as he or she sees fit.
 ...
 \begin{longtable}[!t]{ | P{7cm} | P{2.5cm} |   P{3cm} |  P{3cm} |}
\hline
...
\item 1972: Lab: \fullref{onbeingsaneininsaneplaces}.
...
\item 1973: Lab: \fullref{interpersonaldynamicsinasimulatedprison}.
...
\item 1973: Lab: \fullref{are-analysisofthereliabilityofpsychiatricdiagnosis}.
...
\begin{researchtask}[Fryer]\label{researchtask:fryer}Propose ‘Mental Illness’ -- a classroom demonstration of the Rosenhan study. The game master has an example \fullref{app: mental illness} in the Instructor’s Manual ---1974\end{researchtask}
...
Propose a study, similar to E. Hooker’s, on lesbians, recruiting from the Daughters of Bilitis in 1971. You can see the gamemaster or the original Siegelman, 1972.
...
Propose either a paper in which you critique the medical model used by psychiatry, or collaborate with G. Albee on a symposium on the medical model. This would be best presented in 1972, before the DSM-III is in the works. \begin{researchtask}[Szasz]\label{researchtask:szasz}
Propose a study of how well psychiatric hospitals recognize sane behavior of current patients, like that of Rosenhan, 1973.
\end{researchtask}
...
Propose ‘Clinic in an undergraduate classroom’ (\fullref{app: the clinic}) to the Research committee in ’74 or ’75.
\end{researchtask}
...
Your report should summarize and present your Freudian view carefully.
\end{writingtask}
