...
Proposal to deem the use of aversion therapy as immoral '74 (See \fullref{johnfryermd} - association business \\ \hline

\multicolumn{3}{| P{16cm} |}{\tahead{P. Gebhard}--- Program '71-'74} \\ \hline
Summary of the Kinsey report '72 \fullref{writingtask:gebhard}&
Honor of E. Hooker '72 (\fullref{proposal:gebhard}) \\ \hline
...
(\fullref{proposal:hopcke}) ’72 \\ \hline
...
Propose a condemnation of Socarides' JAMA paper. (\fullref{proposal:marmorB})  '73 \\ \hline
...
Leona Tyler principle (\fullref{proposal:tyler}) ’73 \\ \hline
...
If elected, Presidential address '75&Propose, with Green, a task force on the history of the treatment of homosexuality (\fullref{proposal:spiegel}). &
\\ \hline
...
Propose Taskforce definition of mental illness (\fullref{proposal:spitzerD}) ’75 \\ \hline
...
Propose there is no definition of mental illness (\fullref{proposal:szasz}) ’75 \\ \hline
