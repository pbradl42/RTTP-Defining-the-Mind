...
\\ \hline
\multicolumn{3}{| P{16cm} |}{ \tahead{A. Anastasi}---Program '71-'73} \\
...
\multicolumn{3}{| P{16cm} |}{\tahead{A. Bandura}---VP '71\newline
(Board '71-'73)} \\
...
Oppose Marmor & Gold's '71 proposal to remove 302.0 from DSM-II\\ \hline
...
\multicolumn{3}{| P{16cm} |}{\tahead{K. Clark}---Research '71-'73} \\
...
Sexual experiences of younger women seeking contraceptives. '73\\ \hline
...
*APA v. 3 45 '74-'75 (Clinic in Ugrad classroom)*\\ \hline

\multicolumn{3}{| P{16cm} |}{\tahead{H. Harlow}---Board '71} \\
“Lust, latency and love” - paper '72&
Defend the use of aversion therapy '74&
APA v. 1 \#2 (Operant Conditioning)\\ \hline

\multicolumn{3}{| P{16cm} |}{\tahead{E. Hooker}---Program '71-'72}\\
...
\multicolumn{3}{| P{16cm} |}{\tahead{F. Kameny* / B. Gittings}*} \\
...
APA v. 4 \#80 '73 (Dream Analysis)\\ \hline

\multicolumn{3}{| P{16cm} |}{\tahead{D. Marr*}} \\
'Levels' of explanation paper '75&
&
Propose APA v. 4 \#43 '72 (Magic number 7)\\ \hline
...
&
\\ \hline
\multicolumn{3}{| P{16cm} |}{\tahead{L. Tyler}---Research '71-'72} \\
“Design for a hopeful psychology” - president '73&
Leona Tyler principle '73&
\\ \hline

\multicolumn{3}{| P{16cm} |}{\tahead{J. Spiegel}---Nomenclature '71-'74} \\
...
\multicolumn{3}{| P{16cm} |}{\tahead{R. Spitzer}---Nomenclature '71-'76} \\
...
\tableofcontents
\newpage
\listoftheorems[ignoreall,show={myassign}]

\newpage
\listoftheorems[ignoreall,show={mycommittees}]
\newpage
...
Present a paper outlining psychometrics and the use of statistical measures in psychology. Preferably in concert with Spitzer’s ‘Feigner criteria’ in 1972.
\end{writingtask}
...
\textbf{Initial Committee Membership}
\begin{service}[Fordney-Settlage - 1973]\label{service:fordney}No initial committee memberships.
\end{service}
No initial committee membership
...
\textbf{Initial Committee Membership}
None
\begin{service}[Fryer]\label{service:fryer}
None specified, but eligible to run for any.
\end{service}
...
\begin{writingtask}[Fryer]\label{writingtask:anastasi}
...
\textbf{Initial Committee Membership}
\begin{service}[Kameny]\label{service:kameny}Not a member of the APA, so not eligible for committee memberships
\end{service}
None
...
\begin{writingtask}[Kameny]\label{writingtask:anastasi}
Give a paper during the 1971 panel discussion with John Fryer and Evelyn Hooker. 
\end{writingtask}
...
\textbf{Initial Committee Membership}
\begin{service}[Gittings]\label{service:gittings}Not a member of the APA, so indelible for committee memberships.
\end{service}
None 
...
\begin{writingtask}[Milgram]\label{writingtask:anastasi}
...
\textbf{Initial Committee Membership}
\begin{service}[Piaget]\label{service:piaget}None
\end{service}
None
...
\textbf{Initial Committee Membership}
\begin{service}[Szasz]\label{service:szasz}No initial memberships, but is eligible to run for any.
\end{service}
No committee membership at the beginning
...
\textbf{Initial Committee Membership}
\begin{service}[Green]\label{service:green}no initial committee work
\end{service}
...
J. Speigel and you should co-author the report. You should invite responses to your paper from Socarides \& Beiber and Judd Marmor.\footnote{Richard Green's actual paper of the same title was published in 1972 (see `Must Read').}
...
\textbf{Initial Committee Membership}
\begin{service}[Hopcke]\label{service:hopcke}No initial committee memberships, but eligible for any.
\end{service}
...
\textbf{Initial Committee Membership}
\begin{service}[Leif]\label{service:leif}No initial committee memberships, but eligible for any
\end{service}
...
\textbf{Initial Committee Membership}
\begin{service}[Socarides]\label{service:socarides}No initial committee assignment, but eligible for all.
\end{service}
...
\textbf{Initial Committee Membership}
\begin{service}[bieber]\label{service:bieber}No committee membership to start, but eligible for any
\end{service}
...
\end{service}
Start out as member of the nomenclature committee with term expiring 1974. Is eligible for all positions after that term. Run for President.
...
\begin{writingtask}[Bandura]\label{writingtask:anastasi}
...
you are scheduled to give a talk entitled “The mental health of non-patient male homosexuals” during the panel session titled “ Psychiatry: Friend or Foe to Homosexuals: A Dialogue” with John Fryer.
\end{writingtask}
...
\textbf{Initial Committee Membership}
\begin{service}[Chomsky]\label{service:chomsky}No committee memberships at the beginning, but eligible for any.
\end{service}
...
\textbf{Initial Committee Membership}
\begin{service}[Marr]\label{service:marr}No initial committee memberships, but eligible for any.
\end{service}
No initial committee memberships, but eligible for any.
