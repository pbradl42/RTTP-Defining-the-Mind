...
\begin{researchtask}[Fryer]\label{researchtask:fryer}Propose ‘Mental Illness’ -- a classroom demonstration of the Rosenhan study. The game master has an example \fullref{app: mental illness} in the Instructor’s Manual ---1974\end{research}
